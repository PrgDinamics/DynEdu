...
import { actualizarStockDesdePedido } from "@/app/(PrgDinamics)/dynedu/(panel)/inventario/stock/actions";
...
export async function addOrderCommentAction(formData: FormData) {
  ...
  revalidatePath("/dynedu/tracking");
  redirect(`/dynedu/tracking?pedidoId=${pedidoId}#historial`);
}
