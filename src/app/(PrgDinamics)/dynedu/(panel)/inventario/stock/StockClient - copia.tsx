  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" mb={3}>
        Visión general del stock actual por producto. Incluye stock físico,
        reservado (checkout web) y consignado (consignaciones abiertas).
      </Typography>
          ...
          <Table size="small">
            ...
            <TableBody>
              {rowsWithDisponible.map((row) => {
                ...
                const disponible = row.stock_disponible ?? 0;
                const showNegative = disponible < 0 || (row.stock_fisico ?? 0) < 0;
